...
<a {href} aria-label="Gå till din profil" class="h-42 w-full">
  ...
  >
    <div class="flex flex-col flex-1 gap-y-2 md:gap-y-4 justify-center items-center">
      <div
        class="p-2 md:p-3 rounded-lg bg-accent/10 flex justify-center items-center"
      >
        <slot />
      </div>
