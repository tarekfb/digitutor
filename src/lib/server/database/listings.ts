...
export const getListingById = async (supabase: SupabaseClient<Database>, id: string): Promise<Listing | null> => {
...
export const createListing = async (supabase: SupabaseClient<Database>, input: { title: string, hourlyPrice: string }): Promise<Listing> => {
  ...
  if (data === null) {
    console.log('Failed to create listing. Listing is null.', { dbListing, error })
    throw error
  }
